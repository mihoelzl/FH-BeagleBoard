...
Rectangle {
    ...
    Component {
        ...
        Item {
            ...
            Row {
                id: topLayout
                x: 10; y: 10; height: contactPic.height; width: parent.width
                spacing: 10
                ...
                Column {
                    height: contactPic.height; width: background.width-contactPic.width-20
                    spacing: 5
                    Column {
                        Text { id: name; text: model.name; font.bold: true; font.pointSize: 15 }
                        Text { id: number; text: model.number; font.bold: true; font.pointSize: 9 }
                    }
                    Text {
            ...
            Item {
                ...
                Text {
                    id: smsListTitle
                    text: "List of Messages"; font.pointSize: 12; font.bold: true
                    anchors.top: parent.top
                }
                Flickable {
                    id: flick
                    anchors.top: smsListTitle.bottom; anchors.bottom: parent.bottom
                    width: parent.width; contentHeight: methodText.height; clip: true
                    Text { id: methodText; text: model.messages; wrap: true; width: details.width }
                }
                Image {
            ...
            states: State {
                ...
                PropertyChanges { target: contactPic; width: 128; height: 128 }
    ...
    ListView {
        id: list
        model: myModel; delegate: contactDelegate
